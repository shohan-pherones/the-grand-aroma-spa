...
export default function SliderTestimonial({ reviews }) {
  useEffect(() => {
  ...
  return (
    <>
      <div className="relative w-full glide-08 px-5 sm:px-10 md:px-20 lg:px-32 xl:px-40">
        <div
          className="overflow-hidden text-center bg-white rounded-lg shadow-xl text-gray-500 cursor-grab py-10"
          data-glide-el="track"
        >
                  ...
                  <div className="overflow-hidden ">
                    <div className="relative p-6">
                      <figure className="relative z-10">
                        ...
                        <figcaption className="flex flex-col items-center gap-2 p-6 text-sm text-primary">
                          <div className="flex items-center gap-4 pt-4 text-sm text-left text-primary">
                            <img
                              src={review.img}
                              alt={review.name}
                              title={review.name}
        ...
        >
          {reviews?.map((review, i) => (
            ...
            >
              <span className="block w-3 h-3 transition-colors duration-300 rounded-full bg-white/20 opacity-70 ring-1 ring-gray-700 focus:outline-none"></span>
            </button>
          ))}
        </div>
      </div>
